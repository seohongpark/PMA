...
def create_log_dir(
    ...
    log_dir = osp.join(base_log_dir, run_group, exp_prefix)
...
def setup_logger(
    ...
    log_dir = create_log_dir(run_group, exp_prefix, **create_log_dir_kwargs)
    ...
    if log_to_wandb:
        ...
        wandb.init(name=exp_name, config=variant, project='', entity='', group=run_group)  # Fill out this
