...
class SimpleReplayBuffer(ReplayBuffer):
    ...
    def load_snapshot(self, snapshot):
        for t in range(snapshot['replay_buffer/observations'].shape[0]):
            self.add_sample(
                observation=snapshot['replay_buffer/observations'][t],
                action=snapshot['replay_buffer/actions'][t],
                reward=snapshot['replay_buffer/rewards'][t],
                next_observation=snapshot['replay_buffer/next_observations'][t],
                terminal=snapshot['replay_buffer/terminals'][t],
            )
