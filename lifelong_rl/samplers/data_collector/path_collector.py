...
class MdpPathCollector(PathCollector):
    ...
    def __init__(
        ...
        self.use_gpu = not (ptu.device.type == 'cpu')
...
class LatentPathCollector(MdpPathCollector):
    ...
    def __init__(self, sample_latent_every=None, z_eq_a=False, last_ground=False, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.sample_latent_every = sample_latent_every
        self.z_eq_a = z_eq_a
        self.last_ground = last_ground
        self.prev_latent = None
        self.rollout_func = rollout_with_latent

    def rollout_function(self, *args, **kwargs):
        return rollout_with_latent(sample_latent_every=self.sample_latent_every, z_eq_a=self.z_eq_a, last_ground=self.last_ground, *args, **kwargs)
