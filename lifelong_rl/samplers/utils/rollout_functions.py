...
def rollout(
    ...
    while path_length < max_path_length:
        ...
        next_o, r, d, env_info = env.step(a, render=render)
        observations.append(o)
        rewards.append(r)
        terminals.append(d)
        actions.append(a)
...
def rollout_with_latent(
    ...
    while path_length < max_path_length:
        ...
        a, agent_info = agent.get_action(o, deterministic=deterministic, z_eq_a=z_eq_a)
        next_o, r, d, env_info = env.step(a, render=render)
        observations.append(o)
        rewards.append(r)
        terminals.append(d)
    ...
    return dict(
        ...
        next_rewards=np.array(next_rewards).reshape(-1, 1),
    )
